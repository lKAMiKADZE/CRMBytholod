...
namespace CRMBytholod.Settings
{
    public class Const
    {
        ...
        //public const string ConnectionString = @"Data Source = crm.bytholod.com; Initial Catalog = Bytholod; Integrated Security = True";

        public const string ConnectionString = @"Data Source=crm.bytholod.com; Initial Catalog=Bytholod;User ID=SA;Password=7R7r5L2g";
